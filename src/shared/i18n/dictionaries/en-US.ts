...
export const enUS = {
    ...
    dashboard: {
        title: "Overview",
        description: "Track your operation in one place.",
        cards: {
        ...
        upcomingDescription: "Your schedule will appear here.",
        summaryTitle: "Summary",
        summaryDescription: "Operational indicators will appear here.",
    },

    authLayout: {
        headline: "Management that moves with you.",
        description: "Manage clients, professionals, scheduling, attendance and payments in one place.",
    },
    ...
    auth: {
        ...
        login: {
            eyebrow: "WELCOME",
            title: "Sign in to Courtly",
            description: "Access your organization and continue where you left off.",
            passwordUpdated: "Password updated. You can sign in again.",
            forgotPassword: "Forgot my password",
            submit: "Sign in",
            newOrganization: "NEW ORGANIZATION",
            createPrompt: "Want to manage your own business in Courtly?",
            createOrganization: "Create organization",
            customerNote: "Are you a client? Use the access provided by your organization.",
        },
        signup: {
            eyebrow: "FOR MANAGERS",
            title: "Create your organization",
            description: "Your account will own the new organization and receive the Owner role.",
            ownerNoticeTitle: "This registration is not intended for clients.",
            ownerNoticeDescription: "Professionals and clients will be linked later through their dedicated flows.",
            submit: "Continue",
        ...
        forgot: {
            ...
            description: "Enter your email. We will send instructions to create a new password.",
            success: "If an account is associated with this email, you will receive recovery instructions.",
        ...
        errors: {
            ...
            authUnavailable: "The authentication service is unavailable. Please try again shortly.",
            signUpFailed: "We couldn't create your account.",
            invalidCredentials: "Invalid email or password.",
            membershipFailed: "We couldn't identify your organization.",
            emailRequired: "Enter your email.",
            passwordResetFailed: "We couldn't send the password recovery email.",
            passwordUpdateFailed: "We couldn't update the password.",
            sessionExpired: "Your session expired. Please sign in again.",
            invalidInvite: "The invitation is invalid or incomplete.",
            expiredInvite: "The invitation has expired or was already used.",
            unexpected: "We couldn't complete the operation.",
        },
    },

    organizations: {
        onboarding: {
            brandTitle: "Your business. Your identity. One platform.",
            brandDescription: "Configure your tenant to operate with its own language, currency, time zone and identity.",
            eyebrow: "INITIAL SETUP",
            title: "Configure your organization",
            greeting: "Hello, {name}. Let's prepare Courtly for your business.",
            progressLabel: "Organization creation steps",
            steps: ["Business", "Region", "Contact", "Identity"],
        },
        settings: {
            eyebrow: "TENANT",
            title: "Organization",
            description: "Manage identity, regional settings, contacts and readiness for premium tenant capabilities.",
        },
        sections: {
            identity: { title: "Business identity", description: "Information that identifies your organization inside Courtly." },
            regional: { title: "Regional settings", description: "Country, time zone, language, currency and tax registration without rules tied to a single country." },
            contact: { title: "Contact and address", description: "Information used in organization communications and operations." },
            branding: { title: "Visual identity", description: "Define tenant base colors while preserving the Courtly experience." },
            enterprise: { title: "Custom domains", description: "The foundation is ready for custom domains and custom email domains in future plans." },
        },
        fields: {
            ...
            registrationType: "Tax registration type",
            registrationNumber: "Registration number",
            contactEmail: "Contact email",
            replyToEmail: "Reply-to email",
            phoneCountryCode: "International dialing code",
            phone: "Phone",
            website: "Website",
        ...
        help: {
            slug: "Can later be used in subdomains such as your-business.courtly.com.",
            country: "Accepts any ISO 3166-1 alpha-2 code, such as BR, US, PT or GB.",
        },
        businessTypes: {
        ...
        future: {
            title: "Ready to grow",
            description: "Custom domains, custom email domains, white-label and dedicated infrastructure are prepared in the model without adding operating cost now.",
            items: "Custom domain • Custom email domain • Dedicated tenant",
            notConfigured: "Not configured",
        },
        actions: { back: "Back", continue: "Continue", create: "Create organization", save: "Save organization" },
        feedback: { updated: "Organization updated successfully." },
        errors: {
            professionalNameRequired: "Enter your name.",
            displayNameRequired: "Enter the business name.",
            businessTypeInvalid: "Select a valid business type.",
            countryInvalid: "Enter a valid 2-letter country code.",
            timezoneInvalid: "Enter a valid IANA time zone.",
            localeInvalid: "Select a supported language.",
            currencyInvalid: "Enter a valid 3-letter ISO currency code.",
            slugInvalid: "Enter a valid tenant identifier.",
            slugAlreadyUsed: "This identifier is already in use. Choose another one.",
            colorInvalid: "Enter valid hexadecimal colors.",
            createFailed: "We couldn't create your organization.",
            updateFailed: "We couldn't update your organization.",
            forbidden: "Only the owner can change these settings.",
            invalidData: "Review the information and try again.",
        },
    },
